...
\lhdr{Code point} & \rhdr{Control Code Alias} \\ \capsep
\endhead
\ucode{0000} & \uname{NULL} \\ \rowsep
\ucode{0001} & \uname{START OF HEADING} \\ \rowsep
\ucode{0002} & \uname{START OF TEXT} \\ \rowsep
\ucode{0003} & \uname{END OF TEXT} \\ \rowsep
\ucode{0004} & \uname{END OF TRANSMISSION} \\ \rowsep
\ucode{0005} & \uname{ENQUIRY} \\ \rowsep
\ucode{0006} & \uname{ACKNOWLEDGE} \\ \rowsep
\ucode{0007} & \uname{ALERT} \\ \rowsep
\ucode{0008} & \uname{BACKSPACE} \\ \rowsep
\ucode{0009} & \uname{CHARACTER TABULATION} \\ \rowsep
\ucode{0009} & \uname{HORIZONTAL TABULATION} \\ \rowsep
\ucode{000a} & \uname{LINE FEED} \\ \rowsep
\ucode{000a} & \uname{NEW LINE} \\ \rowsep
\ucode{000a} & \uname{END OF LINE} \\ \rowsep
\ucode{000b} & \uname{LINE TABULATION} \\ \rowsep
\ucode{000b} & \uname{VERTICAL TABULATION} \\ \rowsep
\ucode{000c} & \uname{FORM FEED} \\ \rowsep
\ucode{000d} & \uname{CARRIAGE RETURN} \\ \rowsep
\ucode{000e} & \uname{SHIFT OUT} \\ \rowsep
\ucode{000e} & \uname{LOCKING-SHIFT ONE} \\ \rowsep
\ucode{000f} & \uname{SHIFT IN} \\ \rowsep
\ucode{000f} & \uname{LOCKING-SHIFT ZERO} \\ \rowsep
\ucode{0010} & \uname{DATA LINK ESCAPE} \\ \rowsep
\ucode{0011} & \uname{DEVICE CONTROL ONE} \\ \rowsep
\ucode{0012} & \uname{DEVICE CONTROL TWO} \\ \rowsep
\ucode{0013} & \uname{DEVICE CONTROL THREE} \\ \rowsep
\ucode{0014} & \uname{DEVICE CONTROL FOUR} \\ \rowsep
\ucode{0015} & \uname{NEGATIVE ACKNOWLEDGE} \\ \rowsep
\ucode{0016} & \uname{SYNCHRONOUS IDLE} \\ \rowsep
\ucode{0017} & \uname{END OF TRANSMISSION BLOCK} \\ \rowsep
\ucode{0018} & \uname{CANCEL} \\ \rowsep
\ucode{0019} & \uname{END OF MEDIUM} \\ \rowsep
\ucode{001a} & \uname{SUBSTITUTE} \\ \rowsep
\ucode{001b} & \uname{ESCAPE} \\ \rowsep
\ucode{001c} & \uname{INFORMATION SEPARATOR FOUR} \\ \rowsep
\ucode{001c} & \uname{FILE SEPARATOR} \\ \rowsep
\ucode{001d} & \uname{INFORMATION SEPARATOR THREE} \\ \rowsep
\ucode{001d} & \uname{GROUP SEPARATOR} \\ \rowsep
\ucode{001e} & \uname{INFORMATION SEPARATOR TWO} \\ \rowsep
\ucode{001e} & \uname{RECORD SEPARATOR} \\ \rowsep
\ucode{001f} & \uname{INFORMATION SEPARATOR ON} \\ \rowsep
\ucode{001f} & \uname{UNIT SEPARATOR} \\ \rowsep
\ucode{007f} & \uname{DELETE} \\ \rowsep
\ucode{0082} & \uname{BREAK PERMITTED HERE} \\ \rowsep
\ucode{0083} & \uname{NO BREAK HERE} \\ \rowsep
\ucode{0084} & \uname{INDEX} \\ \rowsep
\ucode{0085} & \uname{NEXT LINE} \\ \rowsep
\ucode{0086} & \uname{START OF SELECTED AREA} \\ \rowsep
\ucode{0087} & \uname{END OF SELECTED AREA} \\ \rowsep
\ucode{0088} & \uname{CHARACTER TABULATION SET} \\ \rowsep
\ucode{0088} & \uname{HORIZONTAL TABULATION SET} \\ \rowsep
\ucode{0089} & \uname{CHARACTER TABULATION WITH JUSTIFICATION} \\ \rowsep
\ucode{0089} & \uname{HORIZONTAL TABULATION WITH JUSTIFICATION} \\ \rowsep
\ucode{008a} & \uname{LINE TABULATION SET} \\ \rowsep
\ucode{008a} & \uname{VERTICAL TABULATION SET} \\ \rowsep
\ucode{008b} & \uname{PARTIAL LINE FORWARD} \\ \rowsep
\ucode{008b} & \uname{PARTIAL LINE DOWN} \\ \rowsep
\ucode{008c} & \uname{PARTIAL LINE BACKWARD} \\ \rowsep
\ucode{008c} & \uname{PARTIAL LINE UP} \\ \rowsep
\ucode{008d} & \uname{REVERSE LINE FEED} \\ \rowsep
\ucode{008d} & \uname{REVERSE INDEX} \\ \rowsep
\ucode{008e} & \uname{SINGLE SHIFT TWO} \\ \rowsep
\ucode{008e} & \uname{SINGLE-SHIFT-2} \\ \rowsep
\ucode{008f} & \uname{SINGLE SHIFT THREE} \\ \rowsep
\ucode{008f} & \uname{SINGLE-SHIFT-3} \\ \rowsep
\ucode{0090} & \uname{DEVICE CONTROL STRING} \\ \rowsep
\ucode{0091} & \uname{PRIVATE USE ONE} \\ \rowsep
\ucode{0091} & \uname{PRIVATE USE-1} \\ \rowsep
\ucode{0092} & \uname{PRIVATE USE TWO} \\ \rowsep
\ucode{0092} & \uname{PRIVATE USE-2} \\ \rowsep
\ucode{0093} & \uname{SET TRANSMIT STATE} \\ \rowsep
\ucode{0094} & \uname{CANCEL CHARACTER} \\ \rowsep
\ucode{0095} & \uname{MESSAGE WAITING} \\ \rowsep
\ucode{0096} & \uname{START OF GUARDED AREA} \\ \rowsep
\ucode{0096} & \uname{START OF PROTECTED AREA} \\ \rowsep
\ucode{0097} & \uname{END OF GUARDED AREA} \\ \rowsep
\ucode{0097} & \uname{END OF PROTECTED AREA} \\ \rowsep
\ucode{0098} & \uname{START OF STRING} \\ \rowsep
\ucode{009a} & \uname{SINGLE CHARACTER INTRODUCER} \\ \rowsep
\ucode{009b} & \uname{CONTROL SEQUENCE INTRODUCER} \\ \rowsep
\ucode{009c} & \uname{STRING TERMINATOR} \\ \rowsep
\ucode{009d} & \uname{OPERATING SYSTEM COMMAND} \\ \rowsep
\ucode{009e} & \uname{PRIVACY MESSAGE} \\ \rowsep
\ucode{009f} & \uname{APPLICATION PROGRAM COMMAND} \\
\end{LongTable}
