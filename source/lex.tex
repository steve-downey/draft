...
\ucode{001c} & \unamec{INFORMATION SEPARATOR FOUR} \\
\ucode{001c} & \unamec{FILE SEPARATOR} \\ \rowsep
\ucode{001d} & \unamec{INFORMATION SEPARATOR THREE} \\
\ucode{001d} & \unamec{GROUP SEPARATOR} \\ \rowsep
\ucode{001e} & \unamec{INFORMATION SEPARATOR TWO} \\
\ucode{001e} & \unamec{RECORD SEPARATOR} \\ \rowsep
\ucode{001f} & \unamec{INFORMATION SEPARATOR ON} \\
...
\ucode{0096} & \unamec{START OF GUARDED AREA} \\
\ucode{0096} & \unamec{START OF PROTECTED AREA} \\ \rowsep
\ucode{0097} & \unamec{END OF GUARDED AREA} \\
