...
\indextext{parameter type placeholder!generic|see{generic parameter type placeholder}}
% If we define 'placeholder', use \defnadj{generic parameter type}{placeholder}
